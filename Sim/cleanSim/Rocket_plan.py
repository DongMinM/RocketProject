    ...
    def calculate_next_pos_of_rocket(self):
        ...
        ## free fall
            ...
            if self.params[-1][5] > 0:
                if self.params[-1][2]<0 and self.params[-1][5] < 220:
                    # if self.params[-1][5]<30:
                    #     self.T[2] = 0
                    #     self.Cd_para = 1.2
                    ...
                    # else:
                        ...
                        self.motor_angle = [0,0,-Kp*(0-self.params[-1][9])-Kd*self.params[-1][11]]
                        if self.motor_angle[2] > 5:
                            self.motor_angle[2] = 5
                        elif self.motor_angle[2] < -5 :
                            self.motor_angle[2] = -5
