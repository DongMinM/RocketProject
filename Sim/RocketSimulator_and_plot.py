...
if __name__ == '__main__':
    ...
    while realTime <= 20:
        ...
        rocket_pos_vector = 70*M2@[0,0,1]                               ## rocket body vector in ground (half size of rocket)
